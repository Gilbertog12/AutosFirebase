...
public class Agregar_Auto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agregar__auto);
    ...
    public void onBackPressed(){
        finish();
        Intent i = new Intent(Agregar_Auto.this,Principal.class);
        startActivity(i);
    }
    public boolean validar(){
        if (validar_aux(Placa,cajaPlaca)) return false;

        else if (Metodos.existencia_Auto(Datos.obtenerAutos(),Placa.getText().toString())){
