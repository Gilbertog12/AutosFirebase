...
public class AdaptadorAuto extends RecyclerView.Adapter<AdaptadorAuto.AutoViewHolder>  {
    ...
    public void onBindViewHolder(AdaptadorAuto.AutoViewHolder holder, int position) {
        ...
        holder.marca.setText(res.getStringArray(R.array.Marcas )[a.getMarca()]);
        holder.modelo.setText(res.getStringArray(R.array.Modelos)[a.getModelo()]);
        holder.color.setText(res.getStringArray(R.array.Colores)[a.getColor()]);
