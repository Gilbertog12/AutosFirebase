...
public class Editar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opcMarcaE = res.getStringArray(R.array.Marcas);

        opcModeloE = res.getStringArray(R.array.Modelos);

        opcColorE = res.getStringArray(R.array.Colores);
        ...
        public boolean validarE(){
            ...
            else if (Metodos.Auto_editar(Datos.obtenerAutos(),txtPlacaE.getText().toString(),placa)) {
