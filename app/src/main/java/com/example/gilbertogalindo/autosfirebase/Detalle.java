...
public class Detalle extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            opcMarca = res.getStringArray(R.array.Marcas);
            opcModelo = res.getStringArray(R.array.Modelos);
            opcColor = res.getStringArray(R.array.Colores);
        ...
        public void editar(View v){
            ...
            Intent i = new Intent(Detalle.this, Editar.class);
        ...
        public void onBackPressed(){
            finish();
            Intent i = new Intent (Detalle.this,Principal.class);
            startActivity(i);
        }
